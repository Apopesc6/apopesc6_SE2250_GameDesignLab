...
public class Scoreboard : MonoBehaviour {
    ...
    public void Tweet() //THIS IS THE FUNCTION THAT ALLOWS YOU TO TWEET YOUR SCORE ON TWITTER
    {

        string nameParameter = "You've just gotten a highscore of "+ _score+" on your own unity project!";
